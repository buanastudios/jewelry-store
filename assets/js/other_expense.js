$(function(){
	...
	function gettingRadioLabel(){
		...
		if (option2){
			// return $("#new_expense_label").val();
			return insertNewRadioLabel($("#new_expense_label").val());
		}else{
			return $("#existed_expense_label").val();
		}
	}
	...
	function refillTable(res){		
	    ...
	    $.each(res.data, function(i,v){        
	    	...
	    	$trow = $("<tr/>")                  
                        ...
                        .append($("<td />").addClass("text-center align-middle").html(transaction_column))
